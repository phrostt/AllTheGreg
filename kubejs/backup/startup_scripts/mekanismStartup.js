...
StartupEvents.registry('mekanism:gas', allthemods => {
  ...
  allthemods.createCustom('saturated_tau_gas', () => $Gas($GasBuilder.builder().tint(0xFF8C00)))
  allthemods.createCustom('compressed_air_gas', () => $Gas($GasBuilder.builder().tint(0xDEDEDE)))
})
