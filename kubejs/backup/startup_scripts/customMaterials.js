...
const erMaterials = [
    { name: 'blutonium', color: 0x14147b, oItem: 'bigreactors:blutonium_ingot', oDust: 'bigreactors:blutonium_dust' },
    { name: 'cyanite', color: 0x456e83, oItem: 'bigreactors:cyanite_ingot', oDust: 'bigreactors:cyanite_dust' },
    { name: 'magentite', color: 0xed29ed, oItem: 'bigreactors:magentite_ingot', oDust: 'bigreactors:magentite_dust' },
    { name: 'ludicrite', color: 0xaa47dd, oItem: 'bigreactors:ludicrite_ingot', oDust: 'bigreactors:ludicrite_dust' },
    { name: 'ridiculite', color: 0xe5c1ea, oItem: 'bigreactors:ridiculite_ingot', oDust: 'bigreactors:ridiculite_dust' },
    { name: 'inanite', color: 0xf12664, oItem: 'bigreactors:inanite_ingot', oDust: 'bigreactors:inanite_dust' },
    { name: 'insanite', color: 0x38d58d, oItem: 'bigreactors:insanite_ingot', oDust: 'bigreactors:insanite_dust' }
];
...
const otherMats = [
    ...
    { name: 'restonia', oItem: 'gtceu:restonia_gem' },
    { name: 'palis', oItem: 'gtceu:palis_gem' },
    { name: 'diamatine', oItem: 'gtceu:diamatine_gem' },
    { name: 'void_crystal', oItem: 'gtceu:void_crystal_gem' },
    { name: 'emeradic', oItem: 'gtceu:emeradic_gem' },
    { name: 'enori', oItem: 'gtceu:enori_gem' },
    { name: 'black_quartz', oItem: 'gtceu:black_quartz_gem' },
    { name: 'empowered_restonia', oItem: 'gtceu:empowered_restonia_gem' },
    { name: 'empowered_palis', oItem: 'gtceu:empowered_palis_gem' },
    { name: 'empowered_diamatine', oItem: 'gtceu:empowered_diamatine_gem' },
    { name: 'empowered_void_crystal', oItem: 'gtceu:empowered_void_crystal_gem' },
    { name: 'empowered_emeradic', oItem: 'gtceu:empowered_emeradic_gem' },
    { name: 'empowered_enori', oItem: 'gtceu:empowered_enori_gem' },

];

const otherElements = [
    //need to make sure each 1 of these is useful by checking usage on its dust
    { name: 'radium', oItem: 'chemlib:radium_ingot', oDust: 'chemlib:radium_dust', cBlast: 5400, cVolt: 131072, cIngot: true },
    { name: 'rhenium', oItem: 'chemlib:rhenium_ingot', oDust: 'chemlib:rhenium_dust', cBlast: 5400, cVolt: 131072, cIngot: true },
    { name: 'astatine', oItem: 'chemlib:astatine_ingot', oDust: 'chemlib:astatine_dust', cBlast: 7200, cVolt: 524288, cIngot: true },
    { name: 'graphite', cBlast: 3600, cVolt: 2048, cIngot: true },
    { name: 'strontium', oItem: 'chemlib:strontium_ingot', oDust: 'chemlib:strontium_dust', cBlast: 4500, cVolt: 8192, cIngot: true },
    { name: 'tellurium', oDust: 'chemlib:tellurium_dust', cBlast: 18900, cVolt: 33554432, cIngot: true },
    { name: 'californium', cBlast: 18900, cVolt: 536870912, cIngot: true },
    { name: 'berkelium', cBlast: 18900, cVolt: 134217728, cIngot: true },
    { name: 'polonium', oGem: true},
    { name: 'selenium', oDust: "chemlib:selenium_dust", cPolymer: true},
    { name: 'francium',  oDust: 'chemlib:francium_dust', cIngot: true}, //en
    { name: 'germanium', oDust: 'chemlib:germanium_dust', cVolt: 524416, cIngot: true },
    { name: 'zirconium', oDust: 'chemlib:zirconium_dust', oIngot: 'chemlib:zirconium_ingot', cIngot: true }
];
...
const modalloys = [
    // --- EnderIO Alloys ---
    { name: 'copper_alloy', oItem: 'enderio:copper_alloy_ingot', components: '1x copper, 1x silicon', color: 0x935B3B, iconSet: 'METALLIC', voltage: 32, loss: 2, cBlast: { temp: 1700, duration: 400, volts: 128 } },
    { name: 'conductive_alloy', oItem: 'enderio:conductive_alloy_ingot', components: '1x iron, 1x redstone', color: 0xF7B066, iconSet: 'METALLIC', voltage: 128, loss: 1, cBlast: { temp: 1700, duration: 400, volts: 128 } },
    { name: 'energetic_alloy', oItem: 'enderio:energetic_alloy_ingot', components: '1x gold, 1x redstone, 1x glowstone', color: 0xFFB933, iconSet: 'METALLIC', voltage: 512, loss: 2, cBlast: { temp: 1700, duration: 400, volts: 128 } },
    { name: 'vibrant_alloy', oItem: 'enderio:vibrant_alloy_ingot', components: '1x energetic_alloy, 1x ender_pearl', color: 0xB6F132, iconSet: 'METALLIC', voltage: 2048, loss: 1, cBlast: { temp: 2700, duration: 400, volts: 512 } },
    { name: 'pulsating_alloy', oItem: 'enderio:pulsating_alloy_ingot', components: '1x iron, 1x ender_pearl', color: 0x66FF82, iconSet: 'METALLIC', voltage: 2048, loss: 2, cBlast: { temp: 1700, duration: 400, volts: 512 } },
    { name: 'soularium', oItem: 'enderio:soularium_ingot', components: '1x gold, 1x thermal_extra:soul_sand_dust', color: 0x56402C, iconSet: 'METALLIC', voltage: 128, loss: 0, cBlast: { temp: 2700, duration: 400, volts: 512 } },
    { name: 'dark_steel', oItem: 'enderio:dark_steel_ingot', components: '1x steel, 1x carbon, 1x obsidian', color: 0x3D3D3D, iconSet: 'METALLIC', voltage: 512, loss: 2, cBlast: { temp: 2700, duration: 400, volts: 512 } },
    { name: 'end_steel', oItem: 'enderio:end_steel_ingot', components: '1x dark_steel, 1x endstone, 1x obsidian', color: 0xE6F1A8, iconSet: 'METALLIC', voltage: 2048, loss: 0, cBlast: { temp: 3600, duration: 400, volts: 2048 } },

    // --- Thermal Alloys ---
    { name: 'signalum', oItem: 'alltheores:signalum_ingot', oDust: 'alltheores:signalum_dust', pipe: true, color: 0xFF5500, iconSet: 'METALLIC', voltage: 128, loss: 1, components: '1x silver, 3x copper, 4x redstone', cBlast: { temp: 1700, duration: 400, volts: 512 } },
    { name: 'lumium', oItem: 'alltheores:lumium_ingot', oDust: 'alltheores:lumium_dust', pipe: true, color: 0xFFFFAA, iconSet: 'METALLIC', voltage: 512, loss: 1, components: '1x silver, 3x tin, 2x glowstone', cBlast: { temp: 1700, duration: 600, volts: 2048 } },
    { name: 'enderium', oItem: 'alltheores:enderium_ingot', oDust: 'alltheores:enderium_dust', pipe: true, color: 0x0B6156, iconSet: 'METALLIC', voltage: 2048, loss: 1, components: '1x diamond, 3x lead, 2x ender_pearl', cBlast: { temp: 2700, duration: 800, volts: 8192 } },

    // --- Botania Metals ---
    { name: 'manasteel', oItem: 'botania:manasteel_ingot', element: 'manasteel', color: 0x47CCFF, cDust: true, iconSet: 'METALLIC', voltage: 128, loss: 1 },
    { name: 'elementium', oItem: 'botania:elementium_ingot', element: 'elementium', color: 0xF687FF, cDust: true, iconSet: 'METALLIC', voltage: 512, loss: 2 },
    { name: 'terrasteel', oItem: 'botania:terrasteel_ingot', element: 'terrasteel', color: 0x34FF23, cDust: true, iconSet: 'METALLIC', voltage: 2048, loss: 2 },
    { name: 'gaia', oItem: 'botania:gaia_ingot', element: 'gaia', color: 0xF7A8D8, cDust: true, iconSet: 'METALLIC', voltage: 131072, loss: 2 },
    { name: 'alfsteel', oItem: 'mythicbotany:alfsteel_ingot', element: 'alfsteel', color: 0xFD9D32, cDust: true, iconSet: 'METALLIC', voltage: 32768, superconductor: true },

    // --- Magic Gating Materials ---
    { name: 'hellforged', oItem: 'bloodmagic:ingot_hellforged', element: 'hellforged', color: 0xC1D5EC, iconSet: 'METALLIC', voltage: 512, loss: 2 },
    ...
    { name: 'allthemodium', oItem: 'allthemodium:allthemodium_ingot', element: 'allthemodium', color: 0xFAD64A, iconSet: 'METALLIC', voltage: 32768, superconductor: true, cBlast: { temp: 5400, duration: 1200, volts: 8192 } },
    { name: 'vibranium', oItem: 'allthemodium:vibranium_ingot', element: 'vibranium', color: 0x6DFF6D, iconSet: 'METALLIC', voltage: 131072, superconductor: true, cBlast: { temp: 5400, duration: 1200, volts: 8192 } },
    { name: 'unobtainium', oItem: 'allthemodium:unobtainium_ingot', element: 'unobtainium', color: 0xA336FF, iconSet: 'METALLIC', voltage: 524288, superconductor: true, cBlast: { temp: 5400, duration: 1200, volts: 8192 } },

    // --- Draconic Evolution ---
    { name: 'draconium', oItem: 'draconicevolution:draconium_ingot', oDust: 'draconicevolution:draconium_dust', element: 'draconium', color: 0x502C6C, iconSet: 'SHINY', voltage: 8192, loss: 1, cBlast: { temp: 4500, duration: 1200, volts: 8192 } },
    { name: 'draconium_awakened', oItem: 'draconicevolution:awakened_draconium_ingot', oDust: 'draconicevolution:awakened_draconium_dust', element: 'draconium_awakened', color: 0xFF6600, iconSet: 'BRIGHT', voltage: 2097152, superconductor: true },
    { name: 'tenebrium', element: 'tenebrium', color: 0x101010, iconSet: 'METALLIC', voltage: 8388608, superconductor: true },

    // --- Mekanism Processing ---
    { name: 'refined_obsidian', oItem: 'mekanism:ingot_refined_obsidian', oDust: 'mekanism:dust_refined_obsidian', components: '1x obsidian, 1x diamond', color: 0x5C3854, iconSet: 'SHINY', voltage: 2048, loss: 2 },
    { name: 'refined_glowstone', oItem: 'mekanism:ingot_refined_glowstone', components: '1x glowstone, 1x osmium', color: 0xFFE30B, iconSet: 'SHINY', voltage: 2048, loss: 1 },
    { name: 'alloy_infused', oItem: 'mekanism:alloy_infused', pipe: true, components: '1x iron', color: 0xE61940, iconSet: 'METALLIC', voltage: 32768, loss: 2 },
    { name: 'alloy_reinforced', oItem: 'mekanism:alloy_reinforced', pipe: true, components: '1x alloy_infused', color: 0x00F5FF, iconSet: 'METALLIC', voltage: 131072, loss: 2 },
    { name: 'alloy_atomic', oItem: 'mekanism:alloy_atomic', pipe: true, components: '1x alloy_reinforced', color: 0xBF40FF, iconSet: 'METALLIC', voltage: 524288, loss: 2 },

    // --- Tech Automation Basics ---
    { name: 'compressed_iron', oItem: 'pneumaticcraft:ingot_iron_compressed', components: '1x iron', color: 0x474747, cDust: true, iconSet: 'METALLIC', voltage: 128, loss: 1 },
    { name: 'hop_graphite', oItem: 'immersiveengineering:ingot_hop_graphite', oDust: 'immersiveengineering:dust_hop_graphite', components: '8x carbon', color: 0x1C1C1C, iconSet: 'DULL', voltage: 8192, loss: 1 },

    // --- Industrial Foregoing & Tech Frames ---
    { name: 'pink_slime', oItem: 'industrialforegoing:pink_slime_ingot', element: 'pink_slime', components: '2x iron, 2x gold', color: 0xE66EA9, iconSet: 'SHINY', voltage: 512, loss: 2 },
    { name: 'plastic', oItem: 'industrialforegoing:plastic', color: 0xA9A9A9, iconSet: 'DULL', voltage: 0, loss: 0 },
    { name: 'deorum', oItem: 'forbidden_arcanus:deorum_ingot', element: 'deorum', components: '4x carbon, 1x gold', color: 0xFFD700, iconSet: 'METALLIC', voltage: 128, loss: 1 },
    { name: 'ferrognetic', oItem: 'forbidden_arcanus:ferrognetic_mixture', pipe: true, color: 0xD1D1D1, components: '1x garmonbozia, 1x dark_steel, 1x pink_slime, 1x alfsteel, 1x hellforged, 1x iesnium', iconSet: 'METALLIC', voltage: 131072, loss: 1, cBlast: { temp: 5400, duration: 1200, volts: 8192 } },
...
const fluids = [
    ...
    { name: 'liquid_source', color: 0xD662FF, iconSet: 'FLUID' },    
...
const newOres = [
    { name: 'calaverite', components: '2x tellurium, 1x gold', iconSet: 'METALLIC', color: 0xDAC084, noDecomp: true },
    { name: 'celestite', components: '1x strontium, 1x sulfur, 4x oxygen', iconSet: 'METALLIC', color: 0xADD8E6, noDecomp: true },
    { name: 'radio_thoric_phosphate', components: '1x thorium, 1x uranium, 1x radium, 1x francium, 1x astatine, 4x phosphorus, 16x oxygen', color: 0x7FFF00, iconSet: 'RADIOACTIVE', formula: '(ThURaFrAt)(PO4)4', noDecomp: true },
    { name: 'argyrodite', components: '1x germanium, 6x sulfur, 8x Silver', iconSet: 'METALLIC', color: 0x8C7B70, noDecomp: true },
    { name: 'kurilite', components: '8x silver, 3x tellurium, 1x selenium', iconSet: 'METALLIC', color: 0x4A5D23, noDecomp: true },
    { name: 'zircon', components: '1x zirconium, 1x silicon, 4x oxygen', color: 0xFFB3B3, iconSet: 'METALLIC', noDecomp: true  },
    { name: 'baddeleyite', components: '1x zirconium, 2x oxygen', color: 0x9999FF, iconSet: 'DULL', noDecomp: true  },
    { name: 'rhenite', components: '1x rhenium, 2x sulfur', iconSet: 'METALLIC', color: 0x8A8A8A, noDecomp: true }
];
...
StartupEvents.postInit(event => {
    ...
    const glycerol = GTMaterials.get('glycerol');
    //TagPrefix.dust.setIgnored(glycerol,'pneumaticcraft:glycerol')
    TagPrefix.gem.setIgnored(glycerol,'pneumaticcraft:glycerol')
    ...
    wills.forEach(mat => {
        let gtMat = GTMaterials.get(mat.name);
        if (gtMat) {
            let gemtItem = Item.of(mat.oGem);
            if (!gemtItem.isEmpty()) {
                TagPrefix.gem.setIgnored(gtMat, gemtItem.item);
            }
        }
    });
...
/*GTCEuStartupEvents.materialModification(event => {
    ...
    wills.forEach(mat => {
        let gtMat = GTMaterials.get(mat.name);
        if (gtMat) { TagPrefix.gem.setIgnored(GTMaterialRegistry.getMaterial(mat.name)); }
    });
    otherMats.forEach(mat => {
        let gtMat = GTMaterials.get(mat.name); 
        ...
        if (gtMat) {
            if (mat.oItem) {
                let ingotItem = Item.of(mat.oItem);
                if (!ingotItem.isEmpty()) TagPrefix.ingot.setIgnored(gtMat, ingotItem.item);
            }
            if (mat.oGem) {
                let gemItem = Item.of(mat.oGem);
                if (!gemItem.isEmpty()) TagPrefix.gem.setIgnored(gtMat, gemItem.item);
            }
            if (mat.oDust) {
                let dustItem = Item.of(mat.oDust);
                if (!dustItem.isEmpty()) TagPrefix.dust.setIgnored(gtMat, dustItem.item);
            }
        }
    });    
})*/