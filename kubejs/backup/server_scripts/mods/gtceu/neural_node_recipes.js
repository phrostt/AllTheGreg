...
ServerEvents.recipes(allthemods => {
    ...
    function neural_node(model, inputs, outputs, duration, power) {
        ...
        if (inputs.includes(' ')) {
            ...
            if (parts[0].endsWith('x')) {
                let numberStr = parts[0].substring(0, parts[0].length - 1);
    ...
    // elder guardian
    neural_node('elder_guardian', '8x ' + input, ['16x minecraft:cod', '2x minecraft:salmon', '2x minecraft:pufferfish', '2x minecraft:tropical_fish', '8x minecraft:prismarine_crystals', '24x minecraft:prismarine_shard', '32x minecraft:wet_sponge', '8x ' + ow], time * 8, LuV * 2)
    // ender dragon
    ...
    // guardian
    neural_node('guardian', '4x ' + input, ['24x minecraft:cod', '16x minecraft:prismarine_crystals', '2x reliquary:guardian_spike', '4x ' + ow], time * 4, IV * 2)
    // hoglin
    neural_node('hoglin', '5x ' + input, ['32x minecraft:porkchop', '16x minecraft:leather', '8x farmersdelight:ham', '5x ' + nether], time * 5, IV * 2)
    // iron golem
    ...
    // pig
    neural_node('pig', '3x ' + input, ['32x minecraft:porkchop', '8x farmersdelight:ham', '3x ' + ow], time * 3, EV * 2)
    // polar bear
    ...
    // squid
    neural_node('squid', '4x ' + input, ['32x minecraft:ink_sac', '32x croptopia:calamari', '2x reliquary:squid_beak', '4x ' + ow], time * 4, EV)
    // basalz
    ...
    // deer
    neural_node('twilightforest/deer', '4x ' + input, ['32x twilightforest:raw_venison', '24x minecraft:leather', '4x ' + tf], time * 4, IV)
    // fire beetle
    ...
    // zombie
    neural_node('zombie', '6x ' + input, ['16x minecraft:rotten_flesh', '8x minecraft:iron_ingot', '16x minecraft:carrot', '16x minecraft:potato', '2x reliquary:zombie_heart', 'bhc:red_heart', '6x ' + ow], time * 6, IV * 2)
    // zombified piglin
