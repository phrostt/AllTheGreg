ServerEvents.recipes(allthemods => {
	...
	allthemods.shaped('4x gtceu:mana_essence_gem', [
        'SIR',
        'IMI',
        'RIS'
    ], {
    ...
    }).id('allthemods:gregification/mana_essence_manual');
    ...
    [
        'botania:pixie_dust', 
        '4x #forge:ingots/elementium', 
        '2x ars_nouveau:source_gem', 
        '2x bloodmagic:infusedslate'
    ],
    null,
    '4x gtceu:flawless_mana_essence_gem',
    400,
    512
	);
    ...
    [
        ...
        '4x #forge:ingots/terrasteel', 
        '2x ars_nouveau:source_gem', 
        '2x bloodmagic:demonslate'
    ],
    null,
    '4x gtceu:exquisite_mana_essence_gem',
    400,
    2048
	);
