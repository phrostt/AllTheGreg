...
GTCEuStartupEvents.registry('gtceu:machine', allthemods => {
   ...
   allthemods.create('flocculation_plant', 'multiblock')
            ...
            .pattern(definition => FactoryBlockPattern.start()
                ...
                .aisle('CCCCC   CCC   CCCCC', 'CC CCCCCCFCCCCCC CC', 'CCFCC   CGC   CCFCC')
                .aisle('CCCCCCCCCCCCCCCCCCC', 'E   PPPPPPPPPPP   I', 'CFFFCCCCCGCCCCCFFFC')
                .aisle('CCCCC   CCC   CCCCC', 'CC CCCCCCFCCCCCC CC', 'CCFCC   CGC   CCFCC')
                .aisle(' CCC    CCC    CCC ', ' CCC    GPG    CCC ', ' CCC    CGC    CCC ')
                .aisle('        CCC        ', '        GPG        ', '        CGC        ')
                .aisle('        CCC        ', '        GPG        ', '        CGC        ')
                .aisle('        CCC        ', '        GPG        ', '        CGC        ')
                .aisle(' CCC    CCC    CCC ', ' CCC    GPG    CCC ', ' CCC    CGC    CCC ')
                .aisle('CCCCC   CCC   CCCCC', 'CC CCCCCCPCCCCCC CC', 'CCFCC   CGC   CCFCC')
                .aisle('CCCCCCCCCCCCCCCCCCC', 'E   PPPPPPPPPPP   I', 'CFFFCCCCCGCCCCCFFFC')
                .aisle('CCCCC   CCC   CCCCC', 'CC CCCCCCFCCCCCC CC', 'CCFCC   CGC   CCFCC')
                .aisle(' CCC    CCC    CCC ', ' CCC    CKC    CCC ', ' CCC    CCC    CCC ')
    ...
    allthemods.create('laser_purification', 'multiblock')
            ...
            .pattern(definition => FactoryBlockPattern.start()
                ...
                .aisle('CGGGC', 'CPPPC', 'CPLPC', 'CPPPC', 'CGGGC')
                .aisle('CGMGC', 'CPPPC', 'ML LM', 'CPPPC', 'CGGGC')
                .aisle('CGGGC', 'CPPPC', 'CPLPC', 'CPPPC', 'CGGGC')
                .aisle('CCKCC', 'CGGGC', 'CGMGC', 'CGGGC', 'CCCCC')
                .where('K', Predicates.controller(Predicates.blocks(definition.get())))
                .where('P', Predicates.blocks('gtceu:tungstensteel_pipe_casing'))
