...
ServerEvents.tags('item', allthemods => {
  ...
  allthemods.add('forge:ores/demonite', 'bloodmagic:sand_hellforged')
  allthemods.add('forge:storage_blocks/raw_demonite', 'bloodmagic:dungeon_metal')
  allthemods.add('forge:storage_blocks/raw_demonite', 'gtceu:hellforged_block')
