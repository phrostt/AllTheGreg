ServerEvents.recipes(allthemods => {
    ...
    soulExtractor(['forbidden_arcanus:soul_extractor', '128x minecraft:soul_sand'], 'gtceu:distilled_water 2000', '128x forbidden_arcanus:soulless_sand', 'gtceu:liquid_soul 2000', 1000, 32768)
