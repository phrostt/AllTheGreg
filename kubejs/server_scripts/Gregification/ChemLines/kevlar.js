ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.large_chemical_reactor('gregification:kevlar/nitrobenzene')
    ...
    event.recipes.gtceu.large_chemical_reactor('gregification:kevlar/aniline')
    ...
    event.recipes.gtceu.large_chemical_reactor('gregification:kevlar/nitroaniline')
    ...
    event.recipes.gtceu.large_chemical_reactor('gregification:kevlar/ppd')
        .notConsumable('#forge:dusts/palladium')
    ...
    event.recipes.gtceu.large_chemical_reactor('gregification:kevlar/p_xylene')
    ...
    event.recipes.gtceu.large_chemical_reactor('gregification:kevlar/terephthalic_acid')        
    ...
    event.recipes.gtceu.chemical_reactor('gregification:kevlar/dimethyl_terephthalate')
    ...
    event.recipes.gtceu.chemical_reactor('gregification:kevlar/sulfur_dichloride')
    ...
    event.recipes.gtceu.chemical_reactor('gregification:kevlar/thionyl_chloride')
    ...
    event.recipes.gtceu.large_chemical_reactor('gregification:kevlar/terephthaloyl_chloride')
    ...
    event.recipes.gtceu.large_chemical_reactor('gregification:kevlar/methylamine')
    ...
    event.recipes.gtceu.chemical_reactor('gregification:kevlar/nmp')
    ...
    event.recipes.gtceu.large_chemical_reactor('gregification:kevlar/liquid_crystal_kevlar')
    ...
    event.recipes.gtceu.chemical_reactor('gregification:kevlar/mda')
    ...
    event.recipes.gtceu.chemical_reactor('gregification:kevlar/phosgene')
    ...
    event.recipes.gtceu.large_chemical_reactor('gregification:kevlar/mdi')
    ...
    event.recipes.gtceu.chemical_reactor('gregification:kevlar/ethylene_glycol')
    ...
    event.recipes.gtceu.chemical_reactor('gregification:kevlar/pentaerythritol')
    ...
    event.recipes.gtceu.large_chemical_reactor('gregification:kevlar/polyurethane_resin')
    ...
    event.recipes.gtceu.chemical_reactor('gregification:kevlar/cobalt_naphthenate')
    ...
    event.recipes.gtceu.chemical_reactor('gregification:kevlar/kevlar_catalyst')
    ...
    event.recipes.gtceu.chemical_reactor('gregification:kevlar/maleic_anhydride')
        .inputFluids('#forge:benzene 1000', '#forge:oxygen 3000')
        .outputFluids('gtceu:maleic_anhydride 1000')
        .duration(200)
        .EUt(512); // HV

    event.recipes.gtceu.chemical_reactor('gregification:kevlar/gamma_butyrolactone')
    ...
    event.recipes.gtceu.chemical_reactor('gregification:kevlar/butyraldehyde')
    ...
    event.recipes.gtceu.chemical_reactor('gregification:kevlar/butanol')
        .inputFluids('#forge:butyraldehyde 1000', '#forge:hydrogen 1000')
        .outputFluids('gtceu:butanol 1000')
        .duration(200)
        .EUt(512); // HV
    
    event.recipes.gtceu.chemical_bath('gregification:kevlar/spin_fiber')
